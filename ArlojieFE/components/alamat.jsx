...
const Alamat = ({ onSubmit, onCancel }) => {
  ...
  const handleSubmit = (e) => {
    ...
    const requiredFields = ['namaLengkap', 'nomorTelepon', 'provinsi', 'kota', 'kecamatan', 'kelurahan', 'alamatLengkap', 'kodePos'];
  ...
  return (
    <div className="bg-white rounded-2xl max-w-xl mx-auto p-6 shadow-2xl">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
            <label className="font-medium text-base mb-1 block">Nama Jalan, No Rumah, Detail Rumah</label>
          <textarea
            name="alamatLengkap"
        ...
        <div className="mb-8">
            <label className="font-medium text-base mb-1 block">Kode Pos</label>
          <textarea
            name="kodePos"
            value={form.kodePos}
            onChange={handleChange}
