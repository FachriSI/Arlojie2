...
const statusColors = {
  aktif: "bg-green-100 text-green-600 px-3 py-1 rounded-full text-sm",
  nonaktif: "bg-red-100 text-red-600 px-3 py-1 rounded-full text-sm"
};
              ...
              <tr key={product.id} className="hover:bg-gray-50">
                <td className="px-4 py-4">
                  <div className="w-12 h-12 bg-gray-100 rounded-lg p-1 flex items-center justify-center">
                    {product.images && (
                      <img
                      src={`http://localhost:3000${JSON.parse(product.images)[0]}`}
                      alt={product.name}
                ...
                <td className="px-4 py-4">
                  <select
                    className="border border-gray-300 rounded-md px-2 py-1 text-sm text-black bg-white"
                    onChange={(e) => {
