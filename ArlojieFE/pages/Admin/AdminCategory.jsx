...
const AdminCategory = () => {
  ...
  loadCategories(); // Panggil saat pertama kali render

  // Tambahkan listener agar ketika kembali dari AddCategory halaman diperbarui
            ...
            {filteredCategories.map((cat) => (
              <tr key={cat.id} className="hover:bg-gray-50">
                ...
                <td className="px-4 py-4">
                  <span className={statusColors[cat.status]}>{cat.status}</span>
                </td>
                <td className="px-4 py-4">
                  <select className="border border-gray-300 rounded-md px-2 py-1 text-sm text-black bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
